package com.rspl.rojgaarrakshak.di

import com.google.gson.GsonBuilder
import com.rspl.rojgaarrakshak.NetworkLayer.ApiFactory
...
class AppModule {
    ...
    @Singleton
    @Provides fun getApiService(retrofitClient : Retrofit) : ApiServices {
