...
class ChoosePhotoTypeBottomSheet(val filePickerListener: FilePickerListener) : BottomSheetDialogFragment(){

    companion object {
        private val TAG = "MainActivity"


        fun newInstance(filePickerListener: FilePickerListener) = ChoosePhotoTypeBottomSheet(filePickerListener)
    }
