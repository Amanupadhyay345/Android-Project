...
class CityAdapter (private val mList: List<SkillCityModel>,val btnlistener:BtnClickListener) : RecyclerView.Adapter<CityAdapter.viewholder>(){
    ...
    private var listdata: MutableList<SkillCityModel> = mList as MutableList<SkillCityModel>

   fun getCityList():List<SkillCityModel>
   {
       return mList
   }
